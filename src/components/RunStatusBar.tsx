    ...
    <section className="run-bar">
      <div className="run-bar-summary">
        <div className="run-summary-cell">
          ...
          <div className="min-w-0"><div className="summary-label">Run 状态</div><div className="truncate text-sm font-semibold text-ink">{run.currentStage}</div></div>
        ...
        <div className="run-summary-cell justify-center border-slate-100 md:border-x md:px-5">
          ...
          <div className="min-w-0">
            <div className="summary-label">当前阶段</div>
        ...
        <div className="run-summary-cell justify-end text-right">
          <div className="min-w-0"><div className="summary-label">下一动作</div>
