...
- Persistent Feishu Workspace Bar showing the reviewed local snapshot boundary.
- Page-level Feishu lineage showing Base tables, transformation, and output on all seven routes.
