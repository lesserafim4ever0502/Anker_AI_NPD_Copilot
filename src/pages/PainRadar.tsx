...
import { AlertTriangle, ArrowRight, ExternalLink, Quote, Radar } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <PageHeader eyebrow="03 / Pain Radar" title="用户痛点雷达" icon={Radar}
        ...
        action={<Link to="/competitor-matrix" className="primary-button">进入机会判断 <ArrowRight size={15} /></Link>} />
